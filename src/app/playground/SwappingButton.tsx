...
const SwappingButton = () => {
    return (
        <div className='p-10 flex justify-center items-center'>
            <button className='group relative flex rounded-md border-2 border-gray py-1 pl-10 pr-2 cursor-pointer items-center overflow-hidden transition-colors duration-300 hover:border-yellow-500'>
